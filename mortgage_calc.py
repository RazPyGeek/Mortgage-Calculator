...
#----------------------------------------
''' A simple python 3 program for
	for calculating fixed and adjustable
	mortgage.
'''
...
class Mortgage(object):
	""" Base class with attributes loan, rate, period"""
...
class Fixed_mortgage(Mortgage):
	""" Calculates for fixed mortgage. Takes two additional variables
		for mortgage payment plan and payment period(years/months/weeks)
	"""
